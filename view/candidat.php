            ...
            <div class="h-100">
                ...
                <ul class="sidebar_nav">
                    ...
                    <li class="sidebar_item">
                        <a href="index.php?route=Condidat" class="sidebar_link"> <img src="img/agents.svg" alt="icon">Candidat</a>
                    </li>
                    <li class="sidebar_item">
                        <a href="index.php?route=Home" class="sidebar_link"> <img src="img/task.svg" alt="icon">Offre</a>
                    </li>
        ...
        <div class="main">
            ...
            <section class="Agents px-4">
                <table class="agent table align-middle bg-white">
                    ...
                    $nonAdmin =new Offers;
                    $get_applayed =$nonAdmin->getAdminNontification();

                    
                    foreach($get_applayed as $app):
                    ?>
                        ...
                        <tr class="freelancer">
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <p class="fw-bold mb-1 f_name"><?php echo $app['username'] ;?></p>
                                       
                                    </div>
                                </div>
                            </td>
                            <td>
                                <p class="fw-normal mb-1 f_title"><?php echo $app['title'] ;?></p>
                                
                            </td>
                            <td>
                                <span class="f_status"><?php echo $app['status'] ;?></span>
                            </td>
